import {toBuffer, setBufferLength, bufferTrimLeft, decodeUtf8Hex, has0xPrefix, verifyAddress} from 'lemo-utils'
...
export function verifyTxConfig(config) {
    if (config.chainID !== undefined && config.chainID !== '') {
...
export function verifyCandidateInfo(config) {
    ...
    if (config.isCandidate || config.isCandidate === undefined) {
