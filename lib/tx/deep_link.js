...
import {CHAIN_ID_MAIN_NET, TX_DEFAULT_GAS_PRICE_UNIT, DEEP_LINK_PREFIX} from '../const'
...
export function createDeepLink(txConfig) {
    const config = {chainID: CHAIN_ID_MAIN_NET, from: 'Lemo83GN72GYH2NZ8BA729Z9TCT7KQ5FC3CR6DJG', ...txConfig}
