...
export default class Tx {
    ...
    static isLemoTx(txConfig) {
        const result = [
            checkFunction(txConfig, 'normalize'),
            checkFunction(txConfig, 'signWith'),
            checkFunction(txConfig, 'serialize'),
            checkFunction(txConfig, 'hash'),
        ]
...
function checkFunction(obj, funName) {
