...
import {TxType, TX_ADDRESS_LENGTH, TX_VERSION, TTTL, TX_DEFAULT_BEFORE_TTTL, TX_DEFAULT_GAS_LIMIT, TX_DEFAULT_GAS_PRICE} from '../const'
...
export default class Tx {
    ...
    normalize(txConfig) {
        ...
        // expirationTime number. seconds. default minus 10 to make sure it is less than the time on server
        this.expirationTime = parseDecInt(txConfig.expirationTime, 0) || (Math.floor(Date.now() / 1000) + TTTL - TX_DEFAULT_BEFORE_TTTL)
