...
// Default expiration time minus 30 to make sure it is less than the time on server
export const TX_DEFAULT_BEFORE_TTTL = 30
...
// gasPrice 单位(Gmo)
export const TX_DEFAULT_GAS_PRICE_UNIT = '1000000000'
// Lemo deep link type
...
export const DeepLinkConfig = [
    {type: DeepLinkType.PAY, prefix: 'lemo://pay?'},
    {type: DeepLinkType.SIGN, prefix: 'lemo://sign?'},
]
...
export const NODE_ID_LENGTH = 130
...
// The max length limit of normal field in deputy
export const MAX_DEPUTY_FIELD_LENGTH = 128
// The max length limit of long field in deputy
export const MAX_DEPUTY_LONG_FIELD_LENGTH = 1024
