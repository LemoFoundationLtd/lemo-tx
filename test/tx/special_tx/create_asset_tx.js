...
describe('CreateAssetTx_new', () => {
    ...
    const tests = [
        ...
        {field: 'decimal', configData: -1, error: errors.TXInvalidRange('decimal', -1, 0, 18)},
        ...
        {field: 'decimal', configData: 0xfffff, error: errors.TXInvalidRange('decimal', 0xfffff, 0, 18)},
        {field: 'decimal', configData: 20, error: errors.TXInvalidRange('decimal', 20, 0, 18)},
